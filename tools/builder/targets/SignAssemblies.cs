    ...
    public static async Task OnExecute(BuildContext context)
    {
        ...
        var binaries =
            new[] {
                ...
                Path.Combine(context.BaseFolder, "src", "xunit.console",          "bin", context.ConfigurationText + "_x86", "net452",                    "xunit.console.x86.exe"),
                Path.Combine(context.BaseFolder, "src", "xunit.console",          "bin", context.ConfigurationText,          "net46",                     "xunit.console.exe"),
                Path.Combine(context.BaseFolder, "src", "xunit.console",          "bin", context.ConfigurationText + "_x86", "net46",                     "xunit.console.x86.exe"),
                Path.Combine(context.BaseFolder, "src", "xunit.console",          "bin", context.ConfigurationText,          "net461",                    "xunit.console.exe"),
                Path.Combine(context.BaseFolder, "src", "xunit.console",          "bin", context.ConfigurationText + "_x86", "net461",                    "xunit.console.x86.exe"),
                Path.Combine(context.BaseFolder, "src", "xunit.console",          "bin", context.ConfigurationText,          "net462",                    "xunit.console.exe"),
                Path.Combine(context.BaseFolder, "src", "xunit.console",          "bin", context.ConfigurationText + "_x86", "net462",                    "xunit.console.x86.exe"),
                Path.Combine(context.BaseFolder, "src", "xunit.console",          "bin", context.ConfigurationText,          "net47",                     "xunit.console.exe"),
                Path.Combine(context.BaseFolder, "src", "xunit.console",          "bin", context.ConfigurationText + "_x86", "net47",                     "xunit.console.x86.exe"),
                Path.Combine(context.BaseFolder, "src", "xunit.console",          "bin", context.ConfigurationText,          "net471",                    "xunit.console.exe"),
                Path.Combine(context.BaseFolder, "src", "xunit.console",          "bin", context.ConfigurationText + "_x86", "net471",                    "xunit.console.x86.exe"),
                Path.Combine(context.BaseFolder, "src", "xunit.console",          "bin", context.ConfigurationText,          "net472",                    "xunit.console.exe"),
                Path.Combine(context.BaseFolder, "src", "xunit.console",          "bin", context.ConfigurationText + "_x86", "net472",                    "xunit.console.x86.exe"),
                Path.Combine(context.BaseFolder, "src", "xunit.console",          "bin", context.ConfigurationText,          "net48",                     "xunit.console.exe"),
                Path.Combine(context.BaseFolder, "src", "xunit.console",          "bin", context.ConfigurationText + "_x86", "net48",                     "xunit.console.x86.exe"),
                Path.Combine(context.BaseFolder, "src", "xunit.console",          "bin", context.ConfigurationText,          "net481",                    "xunit.console.exe"),
                Path.Combine(context.BaseFolder, "src", "xunit.console",          "bin", context.ConfigurationText + "_x86", "net481",                    "xunit.console.x86.exe"),
