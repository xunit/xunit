	...
	public static async Task OnExecute(BuildContext context)
	{
		...
		var binaries =
			new List<string> {
				...
				Path.Combine(context.BaseFolder, "src", "xunit.v3.common.aot",                   "bin", context.ConfigurationText, "net9.0",                                 "xunit.v3.common.aot.dll"),
				Path.Combine(context.BaseFolder, "src", "xunit.v3.core",                         "bin", context.ConfigurationText, "netstandard2.0",                         "xunit.v3.core.dll"),
				Path.Combine(context.BaseFolder, "src", "xunit.v3.core.aot",                     "bin", context.ConfigurationText, "net9.0",                                 "xunit.v3.core.aot.dll"),
				...
				Path.Combine(context.BaseFolder, "src", "xunit.v3.mtp-v2.aot",                   "bin", context.ConfigurationText, "net9.0",                                 "xunit.v3.mtp-v2.aot.dll"),
				...
				Path.Combine(context.BaseFolder, "src", "xunit.v3.runner.common.aot",            "bin", context.ConfigurationText, "net9.0",                                 "xunit.v3.runner.common.aot.dll"),
				...
				Path.Combine(context.BaseFolder, "src", "xunit.v3.runner.inproc.console.aot",    "bin", context.ConfigurationText, "net9.0",                                 "xunit.v3.runner.inproc.console.aot.dll"),
				...
				Path.Combine(context.BaseFolder, "src", "xunit.v3.runner.utility.aot",           "bin", context.ConfigurationText, "net9.0",                                 "xunit.v3.runner.utility.aot.dll"),
			};
