	...
	public static Task OnExecute(BuildContext context)
	{
		...
		var binaries =
			new[] {
				...
				Path.Combine(context.BaseFolder, "src", "xunit.v3.runner.console",        "bin", context.ConfigurationText + "_x86", "net472",         "merged", "xunit.v3.runner.console.x86.exe"),
				...
				Path.Combine(context.BaseFolder, "src", "xunit.v3.runner.console",        "bin", context.ConfigurationText + "_x86", "net48",          "merged", "xunit.v3.runner.console.x86.exe"),
				...
				Path.Combine(context.BaseFolder, "src", "xunit.v3.runner.console",        "bin", context.ConfigurationText + "_x86", "net481",         "merged", "xunit.v3.runner.console.x86.exe"),
