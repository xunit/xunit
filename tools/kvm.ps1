...
function Kvm-Global-Setup {
  ...
  New-Item -Type Directory -Path $kvmBinPath -Force | Out-Null
...
param(
  ...
  if(Test-Path $kreTempDownload) {
    ...
    New-Item -Type Directory -Path $kreTempDownload -Force | Out-Null
  }
  ...
  New-Item -Type Directory -Path $kreFolder -Force | Out-Null
...
function Kvm-List {
  ...
  New-Item -Type Directory -Path ($userKrePath + "\alias\") -Force | Out-Null
...
param(
  ...
  New-Item -Type Directory -Path $userKrePath -Force | Out-Null
  $env:Path = $newPath
@"
SET "PATH=$newPath"
