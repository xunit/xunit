...
{
    /// <summary>
    /// This class be used to do discovery of xunit2 tests, via any implementation
    /// of <see cref="IAssemblyInfo"/>, including AST-based runners like CodeRush and
    /// Resharper. Test authors who are not using AST-based discovery are strongly
    ...
    public class Xunit2Discoverer : ITestFrameworkDiscoverer
    {
        ...
        public Xunit2Discoverer(IAssemblyInfo assemblyInfo)
            : this(assemblyInfo, null, GetXunit2AssemblyPath(assemblyInfo), null, true) { }
        ...
        public Xunit2Discoverer(IAssemblyInfo assemblyInfo, string xunit2AssemblyPath)
            : this(assemblyInfo, null, xunit2AssemblyPath, null, true) { }

        // Used by Xunit2 when initializing for both discovery and execution.
        internal Xunit2Discoverer(string assemblyFileName, string configFileName, bool shadowCopy)
            : this(null, assemblyFileName, GetXunit2AssemblyPath(assemblyFileName), configFileName, shadowCopy) { }
