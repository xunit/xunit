...
/// at the assembly level. Classes which implement this interface must have a constructor that
/// takes <see cref="ICodeGenTestAssembly"/>.
/// </summary>
public interface ICodeGenTestCollectionFactory
{
	/// <summary>
	...
	ICodeGenTestCollection Get(Type testClass);
}
