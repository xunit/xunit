...
public interface INotifyTestCollectionLifecycleAsync : INotifyLifecycle
{
	...
	ValueTask OnTestCollectionFinishedAsync(ICodeGenTestCollection testCollection);

	/// <summary>
	/// Called when the test collection is starting.
	/// </summary>
	/// <param name="testCollection">The test collection</param>
	ValueTask OnTestCollectionStartingAsync(ICodeGenTestCollection testCollection);
}
