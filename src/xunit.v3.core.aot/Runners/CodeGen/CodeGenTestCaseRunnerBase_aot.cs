...
/// </remarks>
public abstract class CodeGenTestCaseRunnerBase<TContext, TTestCase, TTest> : CoreTestCaseRunner<TContext, TTestCase, TTest>
	where TContext : CodeGenTestCaseRunnerBaseContext<TTestCase, TTest>
