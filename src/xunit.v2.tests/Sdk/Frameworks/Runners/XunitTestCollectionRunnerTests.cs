...
public class XunitTestCollectionRunnerTests
{
	...
	public class TestCaseOrderer
	{
		...
		[TestCaseOrderer("XunitTestCollectionRunnerTests+TestCaseOrderer+MyCtorThrowingTestCaseOrderer", "xunit.v2.tests")]
	...
	[TestCaseOrderer("XunitTestCollectionRunnerTests+CustomTestCaseOrderer", "xunit.v2.tests")]
