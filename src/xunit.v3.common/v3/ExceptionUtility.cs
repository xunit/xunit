...
namespace Xunit.v3
{
	...
	public static class ExceptionUtility
	{
		...
		public static string CombineMessages(_IErrorMetadata failureInfo) =>
		...
		/// <returns>The combined string.</returns>
		public static string? CombineStackTraces(_IErrorMetadata failureInfo) =>
