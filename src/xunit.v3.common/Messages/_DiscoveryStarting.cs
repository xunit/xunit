...
public sealed class _DiscoveryStarting : _TestAssemblyMessage, _IAssemblyMetadata, _IWritableAssemblyMetadata
{
	...
	IReadOnlyDictionary<string, IReadOnlyList<string>> _IAssemblyMetadata.Traits => EmptyTraits;

	IReadOnlyDictionary<string, IReadOnlyList<string>> _IWritableAssemblyMetadata.Traits { get => EmptyTraits; set { } }

	string _IAssemblyMetadata.UniqueID =>
		AssemblyUniqueID;
