    ...
    public class Program
    {
        ...
        public static int Main(string[] args)
        {
            try
            {
                ...
                var failCount = RunProject(commandLine.Project, commandLine.Serialize, commandLine.ParallelizeAssemblies,
                                           ...
                                           commandLine.FailSkips, commandLine.StopOnFail);
                              ...
                              bool stopOnFail)
        {
            ...
            using (AssemblyHelper.SubscribeResolve())
            {
                ...
                {
                    var tasks = project.Assemblies.Select(assembly => Task.Run(() => ExecuteAssembly(consoleLock, assembly, serialize, needsXml, parallelizeTestCollections, maxThreadCount, diagnosticMessages, noColor, noAppDomain, failSkips, stopOnFail, project.Filters)));
                ...
                else
                {
                    ...
                    {
                        var assemblyElement = ExecuteAssembly(consoleLock, assembly, serialize, needsXml, parallelizeTestCollections, maxThreadCount, diagnosticMessages, noColor, noAppDomain, failSkips, stopOnFail, project.Filters);
            ...
            try
            {
                ...
                using (var discoveryVisitor = new TestDiscoveryVisitor())
                {
                    ...
                    else
                    {
                        ...
                        if (stopOnFail && resultsVisitor.ExecutionSummary.Failed != 0)
                        {
