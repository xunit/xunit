...
public class DisplayNameFormatterTests
{
	...
	public static IEnumerable<object?[]> ClassAndMethodWithoutOptions => NoOptionsDisplayData(TestMethodDisplay.ClassAndMethod);

	public static IEnumerable<object?[]> MethodWithoutOptions => NoOptionsDisplayData(TestMethodDisplay.Method);

	public static IEnumerable<object?[]> ClassAndMethodWithAllOptions => AllOptionsDisplayData(TestMethodDisplay.ClassAndMethod);

	public static IEnumerable<object?[]> MethodWithAllOptions => AllOptionsDisplayData(TestMethodDisplay.Method);

	public static IEnumerable<object?[]> ClassAndMethodWithReplaceUnderscoreOption => ReplaceUnderscoreOnlyDisplayData(TestMethodDisplay.ClassAndMethod);

	public static IEnumerable<object?[]> MethodWithReplaceUnderscoreOption => ReplaceUnderscoreOnlyDisplayData(TestMethodDisplay.Method);

	public static IEnumerable<object?[]> ClassAndMethodWithReplaceUnderscoreAndOperatorOption => ReplaceUnderscoreAndOperatorDisplayData(TestMethodDisplay.ClassAndMethod);

	public static IEnumerable<object?[]> MethodWithReplaceUnderscoreAndOperatorOption => ReplaceUnderscoreAndOperatorDisplayData(TestMethodDisplay.Method);

	public static IEnumerable<object?[]> ClassAndMethodWithReplaceUnderscoreAndEscapeSequenceOption => ReplaceUnderscoreAndEscapeSequenceDisplayData(TestMethodDisplay.ClassAndMethod);

	public static IEnumerable<object?[]> MethodWithReplaceUnderscoreAndEscapeSequenceOption => ReplaceUnderscoreAndEscapeSequenceDisplayData(TestMethodDisplay.Method);
