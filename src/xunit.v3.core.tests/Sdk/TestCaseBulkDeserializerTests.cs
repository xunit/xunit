...
public class TestCaseBulkDeserializerTests
{
    ...
    public TestCaseBulkDeserializerTests()
    {
        ...
        discoverer = new XunitTestFrameworkDiscoverer(assemblyInfo, configFileName: null, sourceInformationProvider, diagnosticMessageSink);
        executor = new XunitTestFrameworkExecutor(assembly.GetName(), configFileName: null, sourceInformationProvider, diagnosticMessageSink);
    }
