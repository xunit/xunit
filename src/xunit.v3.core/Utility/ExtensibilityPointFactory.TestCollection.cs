...
public static partial class ExtensibilityPointFactory
{
	...
	/// <summary>
	/// Gets the test class orderer that's attached to a test collection. Returns <c>null</c> if there
	/// isn't one attached.
	/// </summary>
	/// <param name="collectionDefinition">The test collection definition</param>
	...
	/// <summary>
	/// Gets the test method orderer that's attached to a test collection. Returns <c>null</c> if there
	/// isn't one attached.
	/// </summary>
	/// <param name="collectionDefinition">The test collection definition</param>
