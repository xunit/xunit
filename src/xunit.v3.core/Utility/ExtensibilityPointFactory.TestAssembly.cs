...
public static partial class ExtensibilityPointFactory
{
	...
	/// <summary>
	/// Gets the test class orderer that's attached to a test assembly. Returns <c>null</c> if there
	/// isn't one attached.
	/// </summary>
	/// <param name="testAssembly">The test assembly</param>
	...
	/// <summary>
	/// Gets the test method orderer that's attached to a test assembly. Returns <c>null</c> if there
	/// isn't one attached.
	/// </summary>
	/// <param name="testAssembly">The test assembly</param>
