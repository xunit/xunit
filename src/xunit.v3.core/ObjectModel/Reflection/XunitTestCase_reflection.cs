...
/// <summary>
/// Default implementation of <see cref="IXunitTestCase"/> for xUnit.net v3 tests that supports test methods
/// decorated with <see cref="FactAttribute"/>. Test methods decorated with derived attributes may use this
/// as a base class to build from.
/// </summary>
/// <remarks>
...
public class XunitTestCase : IXunitTestCase, IAsyncDisposable, IXunitSerializable
{
	...
	string? ITestCaseMetadata.SkipReason => SkipUnless is null && SkipWhen is null ? SkipReason : null;
	...
	/// <summary>
	/// This is the value to be used when constructing <see cref="XunitTest"/>. This is generally
	/// only present when pre-enumerating data theories yields one test case per data row.
	/// </summary>
