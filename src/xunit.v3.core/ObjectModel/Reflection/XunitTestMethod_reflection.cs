...
/// <summary>
/// Default implementation of <see cref="IXunitTestMethod"/> for xUnit.net v3 tests.
/// </summary>
/// <remarks>
...
public class XunitTestMethod : IXunitTestMethod, IXunitSerializable
{
	...
	public XunitTestMethod()
	{
		...
		testCaseOrderer = new(() => RegisteredEngineConfig.GetMethodTestCaseOrderer(Method.ReflectedType ?? Method.DeclaringType ?? throw new InvalidOperationException("Test methods must come from a type"), Method.Name));
