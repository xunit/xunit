	...
	where TTestCase : class, _ITestCase
{
	...
	/// <see cref="_TestCaseCleanupFailure"/>).
	/// </summary>
	/// <remarks>
	...
	/// a "test case finished" message (like <see cref="_TestCaseFinished"/>)  as well as enabling any
	...
	/// a "test case starting" message (like <see cref="_TestCaseStarting"/>) as well as enabling any
