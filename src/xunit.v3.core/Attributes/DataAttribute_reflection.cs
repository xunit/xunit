...
/// <summary>
/// Abstract attribute which represents a base implementation of <see cref="IDataAttribute"/>.
/// Data source providers derive from this attribute and implement <see cref="GetData"/>
/// to return the data for the theory.
/// </summary>
partial class DataAttribute : IDataAttribute
{
	...
	/// </remarks>
	protected internal bool? ExplicitAsNullable { get; set; }
	...
	/// when a value hasn't been set will throw an <see cref="InvalidOperationException"/>.
	/// </remarks>
	protected internal int? TimeoutAsNullable { get; set; }
