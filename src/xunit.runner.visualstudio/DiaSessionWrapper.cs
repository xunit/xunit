            ...
            try
            {
                ...
                if (type != null)
                {
                    ...
                    if (method != null)
                    {
                        ...
                        // Find the compiler-geneated async engine if the test method is async
                        string asyncTypeName = String.Format("{0}+<{1}>d__0", typeName, methodName);
                        Type asyncType = assembly.GetType(asyncTypeName);
                        if (asyncType != null)
                        {
