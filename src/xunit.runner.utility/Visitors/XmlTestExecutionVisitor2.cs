...
namespace Xunit
{
    ...
    /// </summary>
    public class XmlTestExecutionVisitor2 : TestMessageVisitor2
    {
        ...
        public XmlTestExecutionVisitor2(XElement assemblyElement, Func<bool> cancelThunk)
        {
        ...
        /// <summary>
        /// Called when <see cref="TestMessageVisitor2.TestAssemblyFinishedEvent"/> is raised.
        /// </summary>
        ...
        /// <summary>
        /// Called when <see cref="TestMessageVisitor2.TestAssemblyStartingEvent"/> is raised.
        /// </summary>
        /// <param name="args">An object that contains the event data.</param>
        ...
        /// <summary>
        /// Called when <see cref="TestMessageVisitor2.TestCollectionFinishedEvent"/> is raised.
        /// </summary>
        /// <param name="args">An object that contains the event data.</param>
        ...
        /// </summary>
        /// <param name="args">An object that contains the event data.</param>
        protected virtual void Visit(MessageHandlerArgs<ITestClassCleanupFailure> args)
        {
            var cleanupFailure = args.Message;
