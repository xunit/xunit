...
namespace Xunit
{
    ...
    public class Xunit2 : Xunit2Discoverer, IFrontController
    {
        ...
        {
            executor.RunAll(WrapExecutionMessageSink(messageSink), discoveryOptions, executionOptions);
        }
        ...
        {
            executor.RunTests(testCases, WrapExecutionMessageSink(messageSink), executionOptions);
        }
    }
}
