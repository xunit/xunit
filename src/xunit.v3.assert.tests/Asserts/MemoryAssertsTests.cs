...
public class MemoryAssertsTests
{
	...
	public class Equal
	{
		...
		[InlineData(null, "", false, false, false)]//unlike string, ReadonlyMemory<char> of null acts like an empty string, not a distinct value, thus this is equal
		...
		[InlineData(null, new int[] { })]//unlike string, ReadonlyMemory<char> of null acts like an empty string, not a distinct value, thus this is equal
		...
		// Null values
		[InlineData(null, null)]
		[InlineData(null, new string[] { })]//unlike string, ReadonlyMemory<char> of null acts like an empty string, not a distinct value, thus this is equal
