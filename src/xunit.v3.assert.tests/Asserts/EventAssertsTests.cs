...
public class EventAssertsTests
{
    ...
    public class RaisesAnyAsync_Generic
    {
        ...
        public static async Task ExpectedEventButCodeDoesNotRaise()
        {
            ...
            var recorded = await Record.ExceptionAsync(() => Assert.RaisesAnyAsync<EventArgs>(h => x.Completed += h, h => x.Completed -= h, () => Task.Run(() => { })));
    ...
    public class RaisesAsync_Generic
    {
        ...
        public static async Task ExpectedEventButCodeDoesNotRaise()
        {
            ...
            var recorded = await Record.ExceptionAsync(() => Assert.RaisesAsync<EventArgs>(h => x.Completed += h, h => x.Completed -= h, () => Task.Run(() => { })));
