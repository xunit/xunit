...
public class BooleanAssertsTests
{
    public class False
    {
        ...
        public static void ThrowsExceptionWhenTrue()
        {
            ...
            Assert.Equal("Assert.False() Failure" + Environment.NewLine +
                         "Expected: False" + Environment.NewLine +
                         "Actual:   True", ex.Message);
        }
        ...
        public static void UserSuppliedMessage()
        {
            ...
            Assert.Equal("Custom User Message" + Environment.NewLine +
                         "Expected: False" + Environment.NewLine +
                         "Actual:   True", ex.Message);
        }
    }
    ...
    public class True
    {
        ...
        public static void ThrowsExceptionWhenFalse()
        {
            ...
            Assert.Equal("Assert.True() Failure" + Environment.NewLine +
