...
public partial class TestFailed
{
	/// <inheritdoc/>
	/// <remarks>
	/// Note: Will be <see cref="FailureCause.Unknown"/> if there was no value provided during deserialization.
	/// </remarks>
	public required FailureCause Cause { get; set; } = FailureCause.Unknown;
	...
	protected override void Deserialize(IReadOnlyDictionary<string, object?> root)
	{
		...
		Cause = JsonDeserializer.TryGetEnum<FailureCause>(root, nameof(Cause)) ?? Cause;
