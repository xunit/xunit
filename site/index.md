...
|                           | Stable                                             |
| ------------------------- | -------------------------------------------------- | ----------------------------------------
| v3 core framework         | [1.0.1](/releases/v3/1.0.1){: .release }           | ([all releases](/releases/v3/))
| v2 core framework         | [2.9.3](/releases/v2/2.9.3){: .release }           | ([all releases](/releases/v2/))
| xunit.analyzers           | [1.19.0](/releases/analyzers/1.19.0){: .release }  | ([all releases](/releases/analyzers/))
| xunit.runner.visualstudio | [3.0.1](/releases/visualstudio/3.0.1){: .release } | ([all releases](/releases/visualstudio/))
