...
namespace Xunit1.Extensions
{
    public class TheoryAttributeTests
    {
        ...
        internal class TestMethodCommandClass : TestMethodCommandClassBaseClass
        {
            ...
            [Theory, OleDbData(
                @"Provider=Microsoft.Jet.OleDb.4.0; Data Source=xunit.extensions\DataTheories\UnitTestData.xls; Extended Properties=Excel 8.0",
            ...
            [Theory, ExcelData(@"xunit.extensions\DataTheories\UnitTestData.xls", "SELECT x, y, z FROM Data")]
