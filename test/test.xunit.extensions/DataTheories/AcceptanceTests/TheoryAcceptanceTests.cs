...
public class TheoryAcceptanceTests : AcceptanceTest
{
    ...
    public void IncorrectParameterCount()
    {
        ...
        Assert.Equal(@"TheoryAcceptanceTests+IncorrectParameterCountClass.PassingTestData(x: 1)", passedResult.DisplayName);
        FailedResult failedResult = results.OfType<FailedResult>().Single();
        Assert.Equal(@"TheoryAcceptanceTests+IncorrectParameterCountClass.PassingTestData(x: 2, ???: 3)", failedResult.DisplayName);
    }
    ...
    public void NoDataAttributes()
    {
        ...
        Assert.Equal(@"TheoryAcceptanceTests+NoDataAttributesClass.TheoryMethod", failedResult.DisplayName);
        Assert.Equal("System.InvalidOperationException : No data found for TheoryAcceptanceTests+NoDataAttributesClass.TheoryMethod", failedResult.Message);
    }
    ...
    public void EmptyTheoryData()
    {
        ...
        FailedResult failedResult = Assert.IsType<FailedResult>(result);
        Assert.Equal(@"TheoryAcceptanceTests+EmptyTheoryDataClass.TheoryMethod", failedResult.DisplayName);
        Assert.Equal("System.InvalidOperationException : No data found for TheoryAcceptanceTests+EmptyTheoryDataClass.TheoryMethod", failedResult.Message);
    }
    ...
    public void ThrowingData()
    {
        ...
        FailedResult failedResult = Assert.IsType<FailedResult>(result);
        Assert.Equal(@"TheoryAcceptanceTests+ThrowingDataClass.TheoryWithMisbehavingData", failedResult.DisplayName);
        Assert.Contains("System.InvalidOperationException : An exception was thrown while getting data for theory TheoryAcceptanceTests+ThrowingDataClass.TheoryWithMisbehavingData", failedResult.Message);
    }
