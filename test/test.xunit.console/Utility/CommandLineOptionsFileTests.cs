...
#pragma warning restore CS0618
    ...
    class TestableCommandLineOptionsFileReader : CommandLineOptionsFileReader
    {
        public readonly IRunnerReporter Reporter;

        private TestableCommandLineOptionsFileReader(string fileContents, string optionsFileName)
