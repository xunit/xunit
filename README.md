...
xUnit.net is a free, open source, community-focused unit testing tool for C#, F#, and Visual Basic. xUnit.net v2 supports .NET Core 1.0 or later (including .NET 5 or later), and .NET Framework 4.5.2 or later.
...
* _New to xUnit.net? Get started with the [.NET SDK](https://xunit.net/docs/getting-started/v2/getting-started)._
